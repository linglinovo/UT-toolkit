...
def click_button_5_actions():
    ...
    def click_5_actions():
        ...
        if os.path.exists(utfliepath):
            ...
            combobox["value"] = (
            "初始(0)", "第一个存档点(2)", "下一个房间按钮开门后(3)", "扳下一个拉杆后(4.5)", "两个拉杆后(5)",
            "与人偶战斗前(5.5)", "与人偶战斗后(7)", "牵手过桥后(8)", "刚被扔下后(9)", "第二个存档点（已接到电话）(9.2)",
            "接到问口味电话后(9.4）", "接到确认口味电话后（9.6）", "确认过敏源后(9.8)", "Napstablook战后(11)",
