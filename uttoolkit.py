...
def click_button_5_actions():
    ...
    def click_4_actions():
        if os.path.exists(utfliepath):
            ...
            messagebox.showwarning("提示", "您似乎没有存档")
    _button1 = tk.Button(child_window, text="再无交易", command=lambda:click_1_actions(),font=("微软雅黑", 15))
    _button1.pack(pady=10)
    _button2 = tk.Button(child_window, text="吸收6魂", command=lambda:click_2_actions(),font=("微软雅黑", 15))
    _button2.pack(pady=10)
    _button3 = tk.Button(child_window, text="远程折跃", command=lambda:click_3_actions(),font=("微软雅黑", 15))
    _button3.pack(pady=10)
    _button4 = tk.Button(child_window, text="编辑存档信息文件", command=lambda:click_4_actions(),font=("微软雅黑", 15))
